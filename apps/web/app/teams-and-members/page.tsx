...
import { TeamsAndMembers } from "@/components/ui/teams-and-members";
...
export default async function Page() {
  ...
  return (
    <DashboardAdmin teams={teams} userProfile={userProfile}>
      <TeamsAndMembers teams={teams} members={members} />
    </DashboardAdmin>
  );
}
